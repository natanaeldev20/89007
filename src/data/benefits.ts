export const benefits = [
  ...
  {
    id: 2,
    url: "https://lazosdelagente.com/wp-content/uploads/2019/05/shutterstock_375846688.png", // Considera subirla a Cloudinary
    title: "Profesores capacitados",
    description:
      "Nuestro equipo docente se capacita constantemente para brindar una educación de calidad.",
    route: "#",
    color: "#8cc63f",
  },
  {
    id: 3,
    url: "https://www.rededuca.net/sites/default/files/2024-05/Dise%C3%B1o%20sin%20t%C3%ADtulo%20%2815%29.jpg", // También considera subirla
    title: "Apoyo psicopedagógico",
    description:
      "Acompañamos el desarrollo emocional y cognitivo de nuestros estudiantes.",
    route: "#",
    color: "#039fcf",
  },
  {
