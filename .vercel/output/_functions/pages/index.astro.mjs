...
import $$News from '../chunks/News_DiYaM-Tx.mjs';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Instituci\xF3n Educativa N.\xBA 89007" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$Hero, {})} ${renderComponent($$result2, "Welcome", $$Welcome, {})} ${renderComponent($$result2, "News", $$News, { "server:defer": true, "server:component-directive": "defer", "server:component-path": "@sections/home/News.astro", "server:component-export": "default" })} ${renderComponent($$result2, "Benefits", $$Benefits, {})} ${renderComponent($$result2, "Methodology", $$Methodology, {})} ${renderComponent($$result2, "Experiences", $$Experiences, {})} ${renderComponent($$result2, "FormSection", $$FormSection, { "id": "formulario" })} ` })}`;
}, "C:/Users/natan/Escritorio/project/institucioneducativa89007/src/pages/index.astro", "self");
